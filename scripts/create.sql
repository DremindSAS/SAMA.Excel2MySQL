...
CREATE TABLE tb_factura (
    `FECHA DE AUDITORÍA` DATE NOT NULL,
    `DOCUMENTO` CHAR(40) NOT NULL AUTO_INCREMENT,
...
-- Tabla tb_glosa
-- -----------------------------------------------------
CREATE TABLE tb_glosa(
    `CODIGO_GLOSA` CHAR(50) NOT NULL AUTO_INCREMENT,
    ...
    `ESTADO` CHAR(15) NULL,
    PRIMARY KEY (`CODIGO_GLOSA`)
)

-- -----------------------------------------------------
-- Tabla tb_respuesta_opl
-- -----------------------------------------------------
CREATE TABLE tb_respuesta_opl(
    `CODIGO_RESPUESTA_OPL` INT NOT NULL AUTO_INCREMENT,
